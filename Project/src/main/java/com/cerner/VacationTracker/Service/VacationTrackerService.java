...
/**
 * VacationTrackerService is a Service class which provides/receives data to/from DAO class 
 * @author AS078223
 *
 */
@Service
public class VacationTrackerService {
	 ...
	 * @return Associate (returns associate details which includes all the fields mentioned in Associate entity class
	 */
	...
	/**
	 * Invokes getVacationHistoryByAssociateId method defined in VacationRepository class
	 * 
	 * @param associate_id (Unique id which identifies an associate)
	...
	/**
	 * Invokes getVacationCountByAssociateId method defined in VacationRepository class
	 * 
	 * @param associate_id (Unique id which identifies an associate)
